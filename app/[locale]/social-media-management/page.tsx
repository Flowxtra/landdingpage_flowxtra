          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col items-center justify-center w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl overflow-hidden pb-8">
              ...
              >
                ...
                <svg className="w-5 h-5 text-[#1877F2] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-primary dark:text-secondary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
