          ...
          <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-6 flex flex-col">
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              ...
              <li className="flex items-start gap-2 group cursor-pointer">
                ...
                <span className="text-sm text-gray-600 dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover transition-colors">{t("features.kanbanBoard")}</span>
              </li>
              <li className="flex items-start gap-2 group cursor-pointer">
                <svg className="w-5 h-5 text-primary dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover flex-shrink-0 mt-0.5 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <li className="flex items-start gap-2 group cursor-pointer">
                ...
                <span className="text-sm text-gray-600 dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover transition-colors">{t("features.jobWidget")}</span>
              </li>
            </ul>
          ...
          <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-6 flex flex-col">
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              ...
              <li className="flex items-start gap-2 group cursor-pointer">
                ...
                <span className="text-sm text-gray-600 dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover transition-colors">{t("features.rolesPermissions")}</span>
              </li>
              <li className="flex items-start gap-2 group cursor-pointer">
                <svg className="w-5 h-5 text-primary dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover flex-shrink-0 mt-0.5 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-sm text-gray-600 dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover transition-colors">{t("features.hiringStages")}</span>
              </li>
              <li className="flex items-start gap-2 group cursor-pointer">
                <svg className="w-5 h-5 text-primary dark:text-white group-hover:text-button-hover dark:group-hover:text-button-hover flex-shrink-0 mt-0.5 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          >
            ...
            <ul className="space-y-3 mb-8 flex-grow relative z-10">
              <li className="flex items-start gap-2 group cursor-pointer">
                ...
                <span className="text-sm text-white/90 group-hover:text-button-hover transition-colors">{t("features.jobPostings.unlimited")}</span>
              </li>
              <li className="flex items-start gap-2 group cursor-pointer">
